angular.module('optimusApp')
    .controller('tmetricsCtrl', function($rootScope, $scope, $http, $stateParams, $state, $window) {
        $rootScope.checkAuth();
                ...
                $http({
                    ...
                    .then(function(res) {
                        if (res.data.status == true) {
                            ...
                            $http({
                                    method: 'GET',
                                    url: $rootScope.apiUrl + 'tserver/monitorActivity/' + $rootScope.teamId,
                                    params: {
                                        authKey: $rootScope.authKey,
                                        serverId: $scope.serverId
                                    }
        ...
        $scope.copyEmbedModal = function(x) {
            ...
            $scope.chart = x;
            $scope.embedCode = '<iframe src="https://optimuscp.io/dashboard/#!/tembed/' + $rootScope.serverData.id + '/' + $scope.chart + '" width="400" height="300"></iframe>';
        };
